# RSU 2.0 photography credits

Working stock library imported from Pexels on September 12, 2026. Preserve the original filename and photographer name when replacing or exporting these files. Pexels attribution is not required by its license, but RSU should credit photographers wherever the interface permits.

| Local file | Photographer | Original Pexels filename | Working use |
|---|---|---|---|
| `wet-crosswalk-shotsbyvo.jpg` | shotsbyvo | `pexels-shotsbyvo-317256838-15384651.jpg` | Wisdom in Real Life homepage hero |
| `park-paulo-cerqueira.jpg` | Paulo Cerqueira | `pexels-paulo-cerqueira-472736163-15760123.jpg` | Related publication card / ordinary life |
